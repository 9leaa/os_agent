...
git apply --check /absolute/path/to/os_agent/patches/cua/lume-host-isolation.patch
git apply /absolute/path/to/os_agent/patches/cua/lume-host-isolation.patch
cd libs/lume
